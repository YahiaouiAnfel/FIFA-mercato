...
<head>
	...
	<meta charset="utf-8">
	<title>Interface Responsable des Transferts</title>
...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#f6f8f9', endColorstr='#f5f7f9',GradientType=0 );
	">
			...
			<ul class="breadcrumb">
				<li>
					<i class="icon-home"></i>
					<a href="interface_agent.php">Accueil</a> 
					<i class="icon-angle-right"></i>
				</li>
				<li><a href="#">Transferts des joueurs</a></li>
			</ul>
	...
	<!-- alert -->
			...
			<!-- fin d'alert -->
					<div width="100%" class="box-header black " data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>Informations des Transferts</h2>
						<div class="box-icon" >
					...
					<div class="box-content black">
						...
						<table  style="background-image: url(img/fond/c.jpg);width: 100%;background-size:100%;border-radius:15px;box-shadow: 2px 2px 30px #111111;" >
								<tr>
									...
									<td style="color: #FFFFFF;padding-top:30px;text-align: right;">Nom :  </td>
								...
								<tr>
									<td style="color: #FFFFFF;text-align: right;"> de : </td>
								...
								<tr>
									<td style="color: #FFFFFF;text-align: right;"> vers : </td>
									<td style="text-align: center;">
								...
								<tr>
									<td style="color: #FFFFFF;text-align: right;"> Président : </td>
									<td style="text-align: center;">
								...
								<tr>
									<td style="color: #FFFFFF;text-align: right;"> Prix : </td>
									<td style="text-align: center;">
								...
								<tr>
									...
									<?php if (isset($_GET['id'])) { ?>
	<form method="POST">
	<button class="btn btn-small btn-success" value="Ajouter" name="ajo"><i class="halflings-icon ok-circle white"></i>Accepter</button>
									</td>
									<td style="text-align: center;padding-bottom:15px" colspan="2">
	<button type="submit" class="btn btn-small btn-danger" value="Refuser" name="supp" data-target="#supp"><i data-target="#supp"></i>Refuser</button>
									</td>
								<?php  } ?>
				...
				<div class="box span6 black">
					<div class="box-header">
						<h2><i class=" white  halflings-icon pause"></i><span class="break"></span>Transferts en attente</h2>
						<div class="box-icon">
						</div>
					</div>
...
<div class="box span12 black" >
					<div class="box-header" data-original-title="" >
						<h2><i class=" halflings-icon retweet white "></i><span class="break"></span>Liste des transferts effectués</h2>
						<div class="box-icon">
							<a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
						</div>
					</div>
