...
filter: progid:DXImageTransform.Microsoft.gradient( startColorstr='#f6f8f9', endColorstr='#f5f7f9',GradientType=0 );
			...
			<ul class="breadcrumb">
				...
				<li><a href="#">Gestión de jugadores</a></li>
			</ul>
				...
				<div >
					...
					<?php if(isset($msg) && !$msg): ?>
					   <div class="alert alert-danger">
							<strong>La operación de borrado falló</strong>
					   </div>
					<?php endif; ?>
				</div>
			...
			<!-- fin d'alert -->
				...
				<div class="box span12 black" style="">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>Jugadores</h2>
						<div class="box-icon" >
					...
					<div class="box-content">
						...
						<div>
							<button  style="width: 20% ;align:right"  onclick="window.open('addjoueur.php?a=add')" type="button" class="btn btn-primary ">Añadir un jugador</button>
						</div>
							<br>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
          ...
          <h4 class="modal-title">Modificación de la información </h4>
        </div>
				...
				<div class="row-fluid sortable">
					...
					<div class="box-content">
						...
						<table style="background-image: url(img/fond/c.jpg);width: 100%;background-size:100%;border-radius:15px;" >
							...
							<tr>
								<td style="color: #FFFFFF">Nombre del jugador :  </td>
							...
							<tr>
								<td style="color: #FFFFFF">Equipo del jugador :        </td>
							...
							<tr>
								<td></td>
								<td style="color: #FFFFFF">Sagar :        </td>
...
<!--  -->
	...
	<!--modal sup  -->
		<div class="modal  fade" id="sup">
				...
				<div class="modal-body">
					<p>¿Seguro que quieres borrar el reproductor? </p>

				</div>
				<div class="modal-footer">
					<form method="POST">			
  					<input type="submit"  type="button" class="btn btn-danger btn-lg" name="supp" value="Supprimer">
