...
if(isset($_POST['btn-login']))
{
	...
	{
		if($_SESSION['pays']=="ES"||$_SESSION['user_rank']=="2") {
...
<head>
	...
	<title>Mercato - Iniciar sesión</title>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="images/lang/Flag_of_Spain.png"/>
<!--===============================================================================================-->
		...
		<div class="container-login100" style="background-image: url('images/bg_soccer.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50" >
				<span class="login100-form-title p-b-41">
					...
					<img src="images/logo_mercato_es.png" alt="pfe" style="width:30%;text-align:left;" />
					<p style="font-family: 'Bauhaus 93', cursive;text-shadow: 2px 2px 30px #FFFFFF;color: #FFFFFF;font-size:20px">Transferencia de jugadores</p>
...
<!--affichage des erreurs-->
	...
	?>
				<form  method="post" class="login100-form validate-form p-b-33 p-t-5">
					...
					<div class="wrap-input100 validate-input" data-validate = "Inserte su nombre de usuario">
						<input class="input100" type="text" name="txt_mat" placeholder="Nombre del usuario" value="Anil Murthy">
						<span class="focus-input100" data-placeholder="&#xe82a;"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate="Ingrese la contraseña">
						<input class="input100" type="password" name="txt_pass" placeholder="Contraseña" value="MotDePasse5">
						<span class="focus-input100" data-placeholder="&#xe80f;"></span>
					</div>
