				...
				<div >
					...
					<?php if(isset($existj) && $existj) : ?>
					   <div class="alert alert-danger">
							<strong>Erreur:</strong> ce joueur existe déjà !
					   </div>
					<?php endif; ?>

				<?php if(isset($msg3) && $msg3 && !$msg) : ?>
					   <div class="alert alert-success">
							<strong>Merci!</strong> le joueur a été bien ajouté!
					   </div>
					<?php endif; ?>
					<?php if(isset($msg2) && !$msg2) : ?>
					   <div class="alert alert-danger">
							<strong>Erreur:</strong> veuillez remplir tout les infos!
					   </div>
					<?php endif; ?>

					<?php if(isset($msg) && !$msg): ?>
					   <div class="alert alert-danger">
							<strong>Les informations du joueurs n'ont pas été bien enregistrés, veuillez vérifier les champs saisies.</strong>
					   </div>
					<?php endif; ?>

					<?php if(isset($msg) && $msg) : ?>
					   <div class="alert alert-success">
							<strong>Merci! les informations ont bien été enregistrés.</strong>  
					   </div>
					<?php endif; ?>
				</div>
						...
						<form class="form-horizontal"  method="POST" enctype="multipart/form-data">
							<fieldset>
							 ...
							 <div class="control-group">
								<label class="control-label" for="prependedInput">Nom du joueur</label>
								<div class="controls">
							 ...
							 <div class="control-group">
								<label class="control-label" for="prependedInput">Date de fin contrat</label>
								<div class="controls">
								  <div class="input-prepend">
									<?php 
									if ($_GET['a']=='edit') {
							 ...
							 <div class="control-group">
								<label class="control-label" for="prependedInput">Prix repture contrat</label>
								<div class="controls">
								  <div class="input-prepend">
									<?php 
									if ($_GET['a']=='edit') {
							 ...
							 <div class="control-group">
								<label class="control-label" for="prependedInput">Score du joueur</label>
								<div class="controls">
								  <div class="input-prepend">
									<?php 
									if ($_GET['a']=='edit') {
							 ...
							 <div class="control-group">
								<label class="control-label" for="prependedInput">Équipe du joueur</label>
								<div class="controls">
								  <div class="input-prepend">
									<?php 
									if ($_GET['a']=='edit') {
							 ...
							 <div class="control-group">
								<label class="control-label" for="prependedInput">Vitesse du joueur</label>
								<div class="controls">
								  <div class="input-prepend">
									<?php 
									if ($_GET['a']=='edit') {
							 ...
							 <div class="control-group">
								<label class="control-label" for="prependedInput">Dribbles</label>
								<div class="controls">
								  <div class="input-prepend">
									<?php 
									if ($_GET['a']=='edit') {
							 ...
							 <div class="control-group">
								<label class="control-label" for="prependedInput">Tirs</label>
								<div class="controls">
								  <div class="input-prepend">
									<?php 
									if ($_GET['a']=='edit') {
							 ...
							 <div class="control-group">
								<label class="control-label" for="prependedInput">Défense</label>
								<div class="controls">
								  <div class="input-prepend">
									<?php 
									if ($_GET['a']=='edit') {
							 ...
							 <div class="control-group">
								<label class="control-label" for="prependedInput">Performance Physique</label>
								<div class="controls">
								  <div class="input-prepend">
									<?php 
									if ($_GET['a']=='edit') {
							 ...
							 <div class="control-group">
								<label class="control-label" for="prependedInput">Position du joueur</label>
								<div class="controls">
								  <div class="input-prepend">
									<?php 
									if ($_GET['a']=='edit') {
							 ...
							 <div class="control-group">
								<label class="control-label" for="prependedInput">Salaire du joueur</label>
								<div class="controls">
								  <div class="input-prepend">
									<?php 
									if ($_GET['a']=='edit') {
							  ...
							  <div class="control-group">
								...
								<button name="cnf" type="submit" class="btn btn-primary">Enregistrer</button>
								<button name="sup" class="btn">Annuler</button>
							  </div>
