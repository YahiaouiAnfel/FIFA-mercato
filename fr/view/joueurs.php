				...
				<div >
					...
					<?php if(isset($msg) && !$msg): ?>
					   <div class="alert alert-danger">
							<strong>L'opération de suppression a échoué</strong>
					   </div>
					<?php endif; ?>
				</div>
			...
			<!-- fin d'alert -->
				...
				<div class="box span12 black" style="">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>Joueurs</h2>
						<div class="box-icon" >
					...
					<div class="box-content">
						...
						<div>
							<button  style="width: 20% ;align:right"  onclick="window.open('addjoueur.php?a=add')" type="button" class="btn btn-primary ">Ajouter un joueur</button>
						</div>
							<br>
				...
				<div class="row-fluid sortable">
					...
					<div class="box-content">
						...
						<table style="background-image: url(img/fond/c.jpg);width: 100%;background-size:100%;border-radius:15px;" >
							...
							<tr>
								<td style="color: #FFFFFF">Nom du joueur :  </td>
							...
							<tr>
								<td style="color: #FFFFFF">Équipe du joueur:        </td>
							...
							<tr>
								<td></td>
								<td style="color: #FFFFFF">Salaire :        </td>
...
<!--  -->
	...
	<!--modal sup  -->
		<div class="modal  fade" id="sup">
				...
				<div class="modal-body">
					<p>Vous êtes sur de vouloir supprimer le joueur ? </p>
