				...
				<div >
					<?php if(isset($msg) && $msg) : ?>
					   <div class="alert alert-success">
							<strong>Une demande de l'achat a été envoyé, en attendant que le responsable des transferts le confirme</strong>  
					   </div>
					<?php endif; ?>

					<?php if(isset($msg) && !$msg): ?>
					   <div class="alert alert-danger">
							<strong>L'opération de l'achat a échoué</strong>
					   </div>
					<?php endif; ?>
				</div>
...
<?php  if($_SESSION['pays'] != "DZ"){ ?>
				...
				<div class="box span12 black" style="">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>MARCHÉ ALGÉRIEN</h2>
						<div class="box-icon" >
...
<?php  if($_SESSION['pays'] != "FR"){ ?>
				...
				<div class="box span12 black" style="">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>MARCHÉ FRANÇAIS</h2>
						<div class="box-icon" >
							<a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
						</div>
					</div>
...
<?php  if($_SESSION['pays'] != "UK"){ ?>
				...
				<div class="box span12 black" style="">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>MARCHÉ ANGLAIS</h2>
						<div class="box-icon" >
							<a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
						</div>
					</div>
...
<?php  if($_SESSION['pays'] != "ES"){ ?>
				...
				<div class="box span12 black" style="">
					<div class="box-header" data-original-title>
						<h2><i class="halflings-icon white user"></i><span class="break"></span>MARCHÉ ESPAGNOLE</h2>
						<div class="box-icon" >
							<a href="#" class="btn-minimize"><i class="halflings-icon white chevron-up"></i></a>
						</div>
					</div>
    ...
    <div class="modal-dialog modal-sm">
      <div class="modal-content">
        <div class="modal-header">
					...
					<h3>Acheter le joueur</h3>
				</div>
				<div class="modal-body">
					<p>Vous êtes sur de vouloir acheter le joueur ? </p>
