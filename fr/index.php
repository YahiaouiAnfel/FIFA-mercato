...
if(isset($_POST['btn-login']))
{
	...
	{
		if($_SESSION['pays']=="FR"||$_SESSION['user_rank']=="2") {
...
<head>
	...
	<title>Mercato-FR - Connexion</title>
	<meta charset="UTF-8">
	<meta name="viewport" content="width=device-width, initial-scale=1">
<!--===============================================================================================-->	
	<link rel="icon" type="image/png" href="images/lang/Flag_of_France.png"/>
<!--===============================================================================================-->
		...
		<div class="container-login100" style="background-image: url('images/bg_soccer.jpg');">
			<div class="wrap-login100 p-t-30 p-b-50" >
				<span class="login100-form-title p-b-41">
					...
					<img src="images/logo_mercato_fr.png" alt="pfe" style="width:30%;text-align:left;" />
	...
	?>
				<form  method="post" class="login100-form validate-form p-b-33 p-t-5">
					...
					<div class="wrap-input100 validate-input" data-validate = "Insérer votre nom d'utilisateur">
						<input class="input100" type="text" name="txt_mat" placeholder="Nom d'utilisateur" value="Jean-Michel Aulas">
						<span class="focus-input100" data-placeholder="&#xe82a;"></span>
					</div>
					<div class="wrap-input100 validate-input" data-validate="Insérer mot de passe">
						<input class="input100" type="password" name="txt_pass" placeholder="Mot de passe" value="MotDePasse6">
						<span class="focus-input100" data-placeholder="&#xe80f;"></span>
					</div>
